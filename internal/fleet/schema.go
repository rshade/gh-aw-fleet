...
// ExtraWorkflow is a per-repo workflow not from any profile (e.g. hvmesh's
// shadow-engineer). Source "local" means it lives in the target repo and is
// not re-deployed from elsewhere.
