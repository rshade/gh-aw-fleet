...
const (
	...
	// DiagForecastLowConfidence fires when `gh aw forecast --json` marks a
	// Monte Carlo confidence band as unreliable for the selected period.
	DiagForecastLowConfidence         = "forecast_low_confidence"
